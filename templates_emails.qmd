...
## Mentors - 2 weeks before {#mentors1}
...
Before the hackathon we ask that Maintainers take a bit of time to [create and/or label issues](https://ropensci.org/blog/2023/09/19/help-wanted/) in your packages. 
We find that small ‘bite-size’ tasks work well, and small coding-related tasks especially so.
...
## Mentors - 1 week before {#mentors2}
...
## Participants - 2-3 days before {#participants}
