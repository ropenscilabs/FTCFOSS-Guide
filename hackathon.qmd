...
**we suggest offering maintainers/mentors an honorarium** to help equalize participation by offsetting the cost of their time. If you do, prepare clear instructions on how to get paid and sent those instructions with relevants links and template and a why to made questions after the event finished.
...
> Have a mandatory registration was very useful to have an idea if interest and plan for numbers of events, mentors and co-host. We also use the email in the registration to sent the invitations for our Slack.
...
> There is other labels that are very useful, like ['help wanted'](https://ropensci.org/blog/2023/09/19/help-wanted/) and 'good first issue'. You can considerer [different type of label according to the type of project](https://ropensci.org/blog/2024/09/12/labels-writing-projects/).
...
The link to the project and the search is added to the Slack channel to easy access.
...
- Before
    ...
    - [optional] Email links to join the event and instructions on participation one week, one day and one hour before
- During
    - Remind the CoC and share relevants links.
    - Share link to Coworking Document
    - Ask people to add their name and email address to the document if they want to join the Slack
    - Sent Slack invitation to attendees and add them to the event channel
    ...
    - Share contributions on social media (use the event relevant hastag) and in the event Slack channel 
...
During the introduction each mentor and maintainer introduces himself and comments on how he can help or what kind 
of contributions they expects for their package. In this way the attendees can begin to decide what 
they are going to work on and with whom. 
