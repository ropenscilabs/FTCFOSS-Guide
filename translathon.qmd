...
In our pilot case, the translathon was held as a satellite event of the LatinR conference.
Therefore, the date depended on the availability of both the conference schedule and the mentors and editors.
...
> In our pilot we registered attendees free of charge using the same conference registration system.
...
rOpenSci translations are carried out using GitHub projects.
We made sure the differents projects are up todate for the mini traslathons.
...
-   **Introduction (10–15 min)**: Orientation, code of conduct, overview of translation process, mentor/editor introductions.
-   **Coworking (45 min)**: Participants select and work on translation tasks, supported by mentors.
...
-   **Wrap-up (5 min)**: Organizers summarize progress, highlight next steps, and encourage ongoing contributions in Slack.
