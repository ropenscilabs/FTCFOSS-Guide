...
When you organize the traslathon as part of another event, the date depended on the availability of both the conference schedule and the mentors and editors.
...
We made sure the differents projects are up todate for the mini traslathons. Usually the PR listed under `Todo - First Review`
and `Todo - Second Review` are the one to work during the traslathons.
...
-   **Example advertising**
    -   [Social media post before the traslathon] [Mastodon](https://fosstodon.org/@yabellini/113503640649820012) and [LinkedIn](https://www.linkedin.com/posts/latinrconf_tradu%C3%A7%C3%A3o-hackathon-traslaton-ropensci-activity-7264259615213637633-JPvT)
