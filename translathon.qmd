...
rOpenSci translations are carried out using GitHub projects. We made sure the differents projects are up todate for the mini traslathons.
...
> `translation :mate:` is the label used for Spanish translations
> `Tradução` is the label used for Portuguese translations. 
